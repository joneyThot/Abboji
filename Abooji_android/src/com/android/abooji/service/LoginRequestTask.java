...
public class LoginRequestTask extends AsyncTask<String,Integer, Object>{
	...
	private Object register(String email, String password, String company_type) {
		LoginModel loginModel = new LoginModel();
		String result = null;
		String getServerPath = Utils.URL_SERVER_ADDRESS + "login.php"; 
		try
		{
			...
			Gson gson = new Gson();
			loginModel = gson.fromJson(jObj.toString(), LoginModel.class);
